...
class wprp_analytics {
    ...
    public function __construct($mixpanel_token) {
        ...
        $mixpanel_options = array( 'fork' => true, 'consumer' => 'socket', 'async' => false, 'connect_timeout' => 1 );
        if (getenv('SOVRN_ENV') == "QA") {
            $mixpanel_options = array( 'fork' => true, 'consumer' => 'file', 'async' => false, 'connect_timeout' => 0, 'file' => '/tmp/mixpanel.txt' );
        }
    ...
    public function track($label_id, $props= array()) {
